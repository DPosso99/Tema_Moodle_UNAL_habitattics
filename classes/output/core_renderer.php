...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    /**
     * Returns HTML for the language menu dropdown items.
     * Called from navbar.mustache as {{{ output.language_menu }}}.
     *
     * @return string HTML fragment with dropdown-item links or empty string.
     */
    public function language_menu(): string {
        global $CFG;
        ...
        foreach ($data['items'] as $item) {
            ...
            $active = !empty($item['isactive']) ? ' active' : '';
            $html .= '<a class="dropdown-item' . $active . '" href="' . s($url) . '">' . s($item['text']) . '</a>';
        }
