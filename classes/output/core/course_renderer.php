...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
        ...
        $content .= html_writer::start_tag('div', ['class' => 'moove-courses-grid']);
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $rawsummary = $courseutil->get_summary($chelper);
        $plainsummary = '';
        if ($rawsummary) {
            $plainsummary = strip_tags($rawsummary);
            if (strlen($plainsummary) > 140) {
                $plainsummary = substr($plainsummary, 0, 137) . '...';
            }
        }
